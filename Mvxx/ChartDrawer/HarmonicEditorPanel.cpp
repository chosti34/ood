	...
	: wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_STATIC)
{
	...
	m_amplitudeCtrl = new wxTextCtrl(this, AmplitudeCtrl, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER,
	...
	m_frequencyCtrl = new wxTextCtrl(this, FrequencyCtrl, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER,
	...
	m_phaseCtrl = new wxTextCtrl(this, PhaseCtrl, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_PROCESS_ENTER,
...
void HarmonicEditorPanel::OnAmplitudeCtrlChange(wxCommandEvent&)
{
	...
	{
		m_harmonic.amplitude = float(value);
...
void HarmonicEditorPanel::OnFrequencyCtrlChange(wxCommandEvent&)
{
	...
	{
		m_harmonic.frequency = float(value);
		m_attributesChangedSignal();
	}
}
